...
export function AuthLogin({ Back, UserAuthMedium, verifyOTPProps, isPassword, openDataModal }: AuthLoginProps) {
    ...
    console.log("props", Back, "t", UserAuthMedium, "t", verifyOTPProps, "t", isPassword)
    return (
        <div className="flex flex-col bg-white rounded-lg pb-5">
            ...
            {(isPassword && defaultShowPassword) ? <>
                ...
                <div className="text-int-grey-90 ml-5 text-sm">For account {UserAuthMedium}</div>
                <div className="justify-content w-full mt-[2%] items-center justify-between  ">
                    <div className="mb-1 relative items-center w-[90%] mx-[5%] py-2">
                        ...
                        <PrimaryButton block onClick={() => openDataModal()} >LOGIN</PrimaryButton>
                        <div className="flex items-center justify-center relative my-8">
                            <span className="bg-white px-2 text-int-dark-blue cursor-pointer text-sm" onClick={() => setDefaultShowPassword(false)}>Or Login via OTP</span>
                        </div>
                    </div>
                </div>
            </>
                ...
                <>
                    ...
                    <div className="justify-content w-full mt-[2%] items-center justify-between  ">
                        <div className="mb-1 relative items-center w-[90%] mx-[5%] py-2">
                            ...
                            <PrimaryButton block onClick={() => openDataModal()} >LOGIN</PrimaryButton>
                            {isPassword && <div className="flex items-center justify-center relative my-8">
                                <span className="bg-white px-2 text-int-dark-blue cursor-pointer text-sm" onClick={() => setDefaultShowPassword(true)}>Or Login via Password</span>
                            </div>}
                        </div>
                    </div>
                </>
