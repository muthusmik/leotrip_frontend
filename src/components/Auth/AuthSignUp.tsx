          ...
          <div className="mb-1 relative items-center w-[80%] mx-[10%]">
            {!verified && (
              <>
                ...
                <h4 className="fw-bold text-center text-4xl font-poppins pb-[10%]">
                  Enter OTP
                </h4>
                <p
                  className="text-center text-white mb-0"
                  style={{ backgroundColor: "#059f05" }}
                >
                  OTP sent again
                </p>

                <div className="text-int-grey-90 text-muted   mt-2 font-poppins">
                  Mobile Number :+91{!isPhone ? "Mobile Number" : "Email"}{" "}
                  <b>{UserAuthMedium}</b>
                  <br />
                ...
                <div className="justify-content w-full mt-[2%] items-center justify-between pb-[10%] ">
                  <div className="mb-1 relative items-center w-[90%] mx-[5%] py-2">
                    ...
                    <input
                      ...
                      className="border border-black w-full mb-5 py-2 px-3 rounded text-sm font-poppins"
                    />
                    {error && (
                      <div className="text-red-500 text-xs font-semibold mb-2 mx-1 flex">
                        {error}
                      </div>
                    )}
            ...
            {verified && (
              <>
                ...
                <div className="rounded-lg bg-int-green p-2 mx-4 text-[10px]">
                  We have Welcome offers for you ! Use the code{" "}
                  <b>"LEOENTRY"</b> and enjoy <b>upto 20%*</b> <br /> more
                  savings on flights,hotels,bus& more.
                </div>
