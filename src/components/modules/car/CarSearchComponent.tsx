	  ...
	  type={'home'}
        ...
        <div className="flex flex-col md:flex-row w-full items-center justify-between gap-2 px-4 h-auto py-9 ">
          {selectedOption === "airportTransfer" && (
            <div className="bg-white rounded-[10px] border-2 border-black h-[70px] w-[60%] mb-3 md:mb-0">
              <div className="flex flex-row rounded-[16px] h-[70px] px-2 w-full">
                <div className="w-[5%]">
                  <p className="font-poppinsRegular relative bottom-3 bg-white text-center w-[100px] text-xs sm:text-sm">
                    Trip Type
                  </p>
                </div>
                <div className="w-[100%] flex flex-col justify-center px-2">
                  <div className="flex items-center">
                    <select
                      name=""
                      id=""
                      className="w-full h-full outline-none font-poppinsRegular text-lg cursor-pointer text-xs sm:text-sm md:text-md"
          ...
          <AutoSuggestionList
            ...
            value={fromValue}
            placeholder={
              selectedOption === "airportTransfer" && tripType === "fromAirport"
                ? "Airport Name"
                : "Pickup Location"
            }
          ...
          <AutoSuggestionList
            ...
            placeholder={
              selectedOption === "airportTransfer" && tripType === "toAirport"
                ? "Airport Name"
                : "Drop Location"
            }
            data={autoCompleteData}
            ...
            ref={toInputRef}
          />
          <div className="bg-white rounded-[10px] border-2 border-black h-[70px] w-[60%] sm:mb-3 md:mb-0 md:w-[50%]  hover:bg-slate-100">
            <div className="flex flex-row rounded-[16px] h-full px-2 w-full">
              <div className="w-[20%]">
                <p className="font-poppinsRegular relative bottom-3 bg-white text-center w-full text-xs sm:text-sm">
                  Date
                </p>
                <img
                  src={dateSvg}
          ...
          {selectedOption === "roundTrip" && (
            <div className="bg-white rounded-[10px] border-2 border-black h-[70px] w-[60%] hover:bg-slate-100">
        ...
        <div
          className={`absolute  right-[18%] left-0   ${
            selectedOption === "roundTrip" ||
            selectedOption === "airportTransfer"
              ? "top-[41rem] "
              : "top-[35.5rem]"
