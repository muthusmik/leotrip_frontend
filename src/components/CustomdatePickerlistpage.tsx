        ...
        <div className="flex flex-col mx-5">
          ...
          <div className="w-auto h-8 justify-center border-black ">
            <input
              ...
              className="outline-none font-poppinsRegular text-sm text-white  lg:text-md h-full ps-1 w-full bg-int-blue z-50 "
            />
          </div>
        </div>
        {isDatePickerVisible && (
          <div
            ref={wrapperRef}
            className="absolute mt-1   md:pl-0 bg-white rounded-2xl shadow-lg  z-40 w-auto pe-1 "
          >
            <div
