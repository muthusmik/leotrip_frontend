    ...
    <>
      <div className="font-poppinsRegular ">
        <div className="flex flex-row justify-start items-center">
          <h1 className="text-white rounded-lg bg-int-dark-sky px-3 text-base">
            NOTE :
          </h1>
          <p className="ms-2 text-xs">
            Please make sure you enter the Name as per your govt, photo is.
          </p>
        </div>
        ...
        <div className="bg-white">
          ...
          >
            <div className="flex items-center ">
              ...
              <h1 className="text-white font-semibold text-sm ms-3">ADULT <small>(12yrs above)</small></h1>
            </div>
