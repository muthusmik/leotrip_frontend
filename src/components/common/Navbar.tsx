...
function Navbar() {
    ...
    return (
        <>
            <nav className={`navbar bg-white py-1 md:py-1 lg:py-2 shadow-bottom sticky top-0 ${isScrolled ? (openMenu ? "flex flex-wrap h-[125px] animate-slide-in-top" : "h-16 animate-slide-in-top") : (openMenu ? "flex flex-wrap h-[150px] " : 'h-24')
