    ...
    <div ref={wrapperRef} className=" relative mx-2 ml-[5%]">
      {!auth ? (
        ...
        >
          ...
          <span className="font-poppinsRegular text-lg text-int-dark-blue border border-2 border-black border-radius-2 p-1 mx-2 text-center text-wrap hidden lg:flex ">
            Login/Register
          </span>
        </div>
      ) : (
        ...
        >
          ...
          <span className="font-poppinsRegular text-sm border border-2 border-black rounded-md p-1 md:text-lg text-black  mx-1 justify-content mt-2 text-center">
            <b>Logout</b>
          </span>
        </div>
      )}
