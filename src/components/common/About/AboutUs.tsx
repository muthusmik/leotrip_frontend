...
export function AboutUs() {
    return (
        <>
            <div className='bg-[#DBF1FF] h-96 px-[10%] lgxl:px-[12%] lg:px-[5%] mdlg:h-[600px] md:h-[600px]'>
                <div className="w-fit lg:grid lg:grid-rows-1 lg:grid-flow-col lg:gap-10 lgxl:gap-16 items-center py-8 h-96
