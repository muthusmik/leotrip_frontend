...
function Navbar() {
    ...
    return (
        <>
            <nav
                className={`navbar bg-white py-1 md:py-1 lg:py-2 shadow-bottom sticky top-0 rounded-lg text-sm ${isScrolled
                    ? openMenu
                    ...
                    <div className="flex ml-3 items-center space-x-6 md:space-x-16 md:ml-0 lg:ml-[5%] w-full">
                        ...
                        <div className={`hidden md:flex space-x-2 md:space-x-16 py-5 md:py-0 mt-1 w-[60%] `}>
                            {navbarLinks.map((link) => (
                                ...
                                >
                                    <div className={`${isScrolled ? "h-[30px]" : "h-[30px"} mb-1 ${isScrolled ? 'scale-90' : ''} transition-all duration-300`}>
                                        <img src={location.pathname === link.to ? link.activeIcon : link.icon} alt={''} className={`${isScrolled ? 'w-8 h-8' : 'w-10 h-[40px]'}`} />
                                    </div>
                            ...
                            {menuLinks.map((link) => (
                                ...
                                >
                                    <div className={`h-[20px] mb-1 scale-90 transition-all duration-300`}>
                                        <img src={location.pathname === link.to ? link.activeIcon : link.icon} alt={''} className={`w-8 h-auto`} />
                                    </div>
