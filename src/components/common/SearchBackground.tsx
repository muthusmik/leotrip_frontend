...
export function SearchBackground({ children, ...props }: any) {
    ...
    return (
        <>
            <div className='carousel-container flex overflow-hidden justify-center bg-gradient-to-t from-[#85a5b9] to-[#85a5b9] w-full h-[20rem]'>
            ...
            {/* <div className='h-12 bg-[#bfdaea]'></div> */}
        </>
    )
}
