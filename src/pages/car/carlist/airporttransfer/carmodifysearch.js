            ...
            <div className='container modifysearch'>
                <div className='row pt-3'>
                    <div className='col ms-4'>
                        ...
                        <p className='mt-0 ms-3 car-traveldetail'>Airport</p>
                    </div>

                    <div className='col-4 d-flex'>
                        <div>
                            <h5 className='mb-0'>From</h5>
                            <p className='car-depature mt-0'>Chennai Airport</p>
                        </div>
                        <FontAwesomeIcon icon={faLongArrowRight} className="mx-2 mb-0 mt-3" style={{ fontSize: "30px", color: "blue" }} />
                        <div>
                            <h5  className='mb-0'>To</h5>
                            <p className=' mt-0 car-return'>Central RailwayStation</p>
                        </div>
                    </div>
                    <div className='col'>
                    ...
                    <div className='col-3 pt-2'>
                        <Button variant="danger float-end me-5" onClick={() => setModalShow(true)}>
                            Modify Search
                        </Button>
