        ...
        useEffect(() => {
            const showArry = async () => {
                ...
                for (let i = 0; i < length; i++) {
                    ...
                    finalpricevalue = [...finalpricevalue, FlightList.data?.flightDetails[i].OfferedFare]
            ...
            <div>
                <div className='filtersearch d-flex py-2  border-bottom border-1'>
                    ...
                    <span onClick={handleModel}>
                        <img src={Filter} height={"20px"} width={"20px"} className='me-3'></img>
                    </span>
                </div>
                <Modal
                    show={modalShow}
                    ...
                    <Modal.Body>
                        <div className=' border-bottom border-2'>
                            <div className='ms-3 mt-2 mb-2'>
                                ...
                                {show && (
                                    <div onChange={(e) => handlerefund(e.target.value)}>
                                ...
                                {(hide && FlightList.data.flightDetails?.length > 0) ? (
                                    <div className="slider ms-3">
                                        <InputRange
                                            ...
                                            value={val}
                                            onChange={setVal}
                                            onChangeComplete={(args) => handlePrice(args)}
                                        />
                                        <div className='rangevalue'>
                                            {console.log("val.............", val.min)}
                                ...
                                {(onhide && FlightList.data.flightDetails?.length > 0 && myArray.length > 0) ? (
                                    <Card className="flightfiltername">
                                        ...
                                        {withoutDuplicates.map((flight, index) => (
                                            <>
                                                <div key={index} className='pre-airlines' onChange={(e) => onhandle(e.target.value)}>
