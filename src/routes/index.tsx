...
import CarsOneWay from "../modules/car/carlist/oneway/index";
import CarsRoundWay from "../modules/car/carlist/roundTrip/index";
...
import ViewTicket from "modules/flight/flightList/oneWay/payment/ViewTicket";
import { Offer } from "components/common/Offer";
import Review from "modules/car/carlist/oneway/review";
const routes: RouteObject[] = [
  {
    path: "/",
    element: <FlightModule />, // Your bus module component
  },
  {
    path: "/bus",
  ...
  {
    path: "car/car-roundway",
    element: <CarsRoundWay />,
  },
  {
    path: "/car/carlist/oneway/review",
    element: <Review />,
  },
];
