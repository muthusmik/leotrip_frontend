...
const RoomGuestCountComponent = ({
  ...
  const countTag =
    "w-[30px] h-full text-center flex text-lg items-center justify-center font-poppinsRegular";

  return (
    <div
      ref={wrapperRef}
      className="absolute right-0  sm:right-0   top-[10rem] sm:top-[5rem] bg-white rounded-[10px] w-fit z-10"
    >
      <div className={mainContainerStyle}>
        ...
        >
          Rooms<span className="text-xs font-normal">(Max 8)</span>
        </h2>
      ...
      <hr className="pb-2" />
      <h2 className="text-center font-poppinsRegular text-xl font-bold">
        Guests
      </h2>
      <div className={mainContainerStyle}>
        <h2 className="text-center font-poppinsRegular text-lg font-bold">
          Adults
        </h2>
        <div className={subContainerStyle}>
          <div
      ...
      <div className="w-full px-2">
        <h6 className="text-center font-poppinsRegular text-xs mb-2">
      ...
      <hr />
      {isChildAgeValid() ? (
        <div className="flex justify-end   my-1 me-10">
          <div
          ...
          >
            <button className="rounded" onClick={() => handleApply()}>
              <p className="w-auto  px-8 font-poppinsRegular font-bold text-white rounded">
                APPLY
              </p>
            </button>
          </div>
