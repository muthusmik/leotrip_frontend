...
const HotelModifySearch = () => {
    ...
    return (
        <>
            <div className='bg-gradient-to-r from-bg-blue-start to-bg-blue-end flex flex-col md:flex-row items-center justify-between  my-5  h-full py-10 rounded-[20px] shadow-lg'>
