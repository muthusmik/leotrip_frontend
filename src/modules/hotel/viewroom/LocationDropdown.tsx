    ...
    return (
        <>
            <div className='bg-white p-3  mx-5'>
                ...
                <div className='flex w-[100%] border-2 border-[#e0e4e7]'>
                    <div className='w-[30%] bg-[#eaf7fc] '>
                        <div className='bg-[#eaf7fc] mx-1 border-4 border-[#eaf7fc] rounded-lg'>
                    ...
                    <div className='w-[70%]'>
                        <img src={map} alt='map' className='w-full h-96' />
                    </div>
                </div>
                ...
                <div className='bg-white p-3 border-2 border-[#e0e4e7]'>
                    {/* checkIn */}
                    <div className='mx-10 border-b-2 flex p-4'>
                        <div className='w-[30%] flex item-center'>
                    ...
                    <div className='mx-10 border-b-2 flex  p-4'>
                        <div className='w-[30%] flex item-center'>
                            <img src={checkout} alt='checkin' className='w-10 h-10' />
                            <h1 className='m-2 font-bold'>check-in</h1>
                    ...
                    <div className='mx-10 border-b-2 flex  p-4'>
                        <div className='w-[30%] flex item-center'>
                            <img src={ellipsis} alt='checkin' className='w-10 h-10' />
                    ...
                    <div className='mx-10 border-b-2 flex  p-4'>
                        <div className='w-[30%] flex item-center'>
                            <img src={childrenbeds} alt='checkin' className='w-10 h-10' />
                        ...
                        <div className='w-[70%]'>
                            ...
                            <div className='flex border border-black ml-1'>
                                <div className='w-[50%] flex item-center p-2'>
                                    <img src={beds} alt='checkin' className='w-10 h-10' />
                    ...
                    <div className='mx-10 border-b-2 flex p-4'>
                        <div className='w-[30%] flex item-center'>
                            <img src={adult} alt='checkin' className='w-10 h-10' />
                    ...
                    <div className='mx-10 border-b-2 flex p-4'>
                        <div className='w-[30%] flex item-center'>
                            <img src={pets} alt='checkin' className='w-10 h-10' />
                    ...
                    <div className='mx-10 border-b-2 flex p-4'>
                        <div className='w-[30%] flex item-center'>
                            <img src={portablecard} alt='checkin' className='w-10 h-10' />
