                            ...
                            <tr key={index} className="flex flex-row bg-white border border-black border-1 rounded-lg justify-between p-5 diashow-img">
                                <td>
                                    <div className="flex flex-row">
                                        <div> <img src={AI} alt="404" className="mr-2" /></div>
                                ...
                                <td>
                                    <p className="text-int-dark-red text-2xl">&#x20B9; {flight.price}</p>
                                    <div>
                                        <p className="border border-int-blue border-1 rounded-3xl p-1 text-int-blue text-sm">+ More Fare</p>
                                    </div>
                                </td>
                                <td>
