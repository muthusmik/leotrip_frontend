...
const FlightData = {
  ...
  Duration: "01 h 05m",
  Baggage: "25kg",
  BoardingPlaceTime: "5-may-2023/5.05",
  ArrivelPlaceTime: "5-may-2023/6.05",
};
const jsonData = {
  tableHeading: {
...
const instructionData = {
  instructions: [
    ...
    "Check-in begins 2 hours prior to the flight for seatassignment and closes 60 minutes prior to thescheduled departure.",
    "Carriage and other services provided by the carrierare subject to conditions of carriage, which arehereby incorporated by reference. Theseconditions may be obtained from the issuingcarrier.",
    "Indian allows its Guests to check-in up to 15 kg ofluggage per paying passenger. Baggage inexcess of 15 kg is subject to a fee to be paid atthe airport at check-in.",
    "Cancellation Charges shall be as per airline rules.",
    "For any queries please contact IndiGo at18001803838/9910383838 for all MTNL/BSNLphones",
    "Please check the figures / timings as they maychange time to time without any notice to thepassenger."
  ],
};
      ...
      <div className="w-[80%] mx-auto">
        <div className="border my-5 absolute z-50">
          ...
          <div className="flex items-center bg-gradient-to-r from-cyan-400 to-blue-400 p-2 rounded-md">
            ...
            <p className="pl-2 text-lg text-white font-bold">Flight Details</p>
          </div>
          <div className="mx-10">
          ...
          <div className="flex flex-col lg:flex-row justify-start p-2">
            <div className="w-full lg:w-1/2">
              <div className="w-[70%] p-2 border-black border-b-2">
                {Object.entries(priceData).map(([label, value]) => (
                  <div key={label} className="flex my-5 pl-5">
                    <div className="font-bold w-[90%]">{label}:</div>
                    <div className="">&#x20B9;{value}</div>
                  </div>
                ))}
              </div>
