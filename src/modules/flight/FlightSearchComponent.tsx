...
const FlightSearchComponent = () => {
  ...
  return (
    <div className="w-full items-center justify-between gap-6 bg-white px-2 rounded-[20px] shadow-lg mt-28 md:mt-12 h-full">
      ...
      <div className="flex flex-col w-full items-center justify-between gap-2 px-4  md:h-[140px] md:flex-row mt-4">
        ...
        <div className="bg-white rounded-[10px] border-2 border-black  h-[70px]  hover:bg-slate-100">
        ...
        <div className="bg-white rounded-[10px] border-2 border-black  hover:bg-slate-100  h-[70px] flex flex-col justify-center items-center">
