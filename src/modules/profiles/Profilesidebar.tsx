    ...
    <>
      <div className="h-48 w-48 mx-auto border bg-gradient-to-tl from-blue-500 via-blue-50 to-blue-500">
        <img
          src={userImage || user}
          alt="user"
          className={`${user ? "h-20 w-20 m-14" : ""} ${userImage ? "h-48 w-48 m-[0]" : ""
            } z-0 overflow-hidden`}
        />
      ...
      <div className="font-poppinsRegular text-xl ml-7 mt-10 leading-[3.3rem]">
        <button
          ...
          className={`flex gap-x-2 w-48 hover:bg-blue-200 ${isOpen ? "bg-blue-200" : ""
            }`}
        >
        ...
        <button
          onClick={Dropdown}
          className={`flex gap-x-2 w-48 hover:bg-blue-200 ${isDropOpen ? "bg-blue-200" : ""
            }`}
        >
