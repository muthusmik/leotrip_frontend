  ...
  return (
    <>
      <div className="h-full w-full flex gap-[20px]">
        <div
          className={`flex ms-4 mb-0 ${activeTab === "upcoming" ? "border-int-sandal border-b-4" : ""
            }`}
        ...
        <div
          className={`flex ms-4 ${activeTab === "canceled" ? "border-int-sandal border-b-4" : ""
            }`}
        ...
        <div
          className={`flex ms-4 ${activeTab === "completed" ? "border-int-sandal border-b-4" : ""
            }`}
