    ...
    <div className=''>
      <div onClick={handleClick} className={Searchstyle}>
        <div className='row mx-auto'>
          <div className='col datemodirountrange'>
            <p className='mb-0' style={style2}><FontAwesomeIcon icon={faCalendarDays} className="ms-2 me-1 text-secondary " />Departure</p>
            <div className='my-2 text-center ms-1'>{`${departure}`}</div>
          </div>
          <div className='col datemodirountrange  mx-2 me-0'>
            <p className='mb-0' style={style2}><FontAwesomeIcon icon={faCalendarDays} className="ms-3 me-1 text-secondary " />Return</p>
